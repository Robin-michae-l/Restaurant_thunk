...
function Restview() {
  ...
  return (
    <Row>
     ...
     <Col md={3}>
        <img className='rounded'  width={'100%'} height={'500px'} src={selectedRestaurant.photograph} alt="no image" />
     </Col>
     ...
     <Col md={7} className='px-4'>
      ...
      <ListGroup.Item className='text-center p-4'>
        ...
        <Modal.Header closeButton>
          <Modal.Title className='text-warning'>Operaing Hours</Modal.Title>
        </Modal.Header>
        <Modal.Body>
        <ListGroup>
